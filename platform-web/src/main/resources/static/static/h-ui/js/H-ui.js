...
!function($) {
	...
	EmailSug.prototype = {
		...
		create: function(elem, value) {
			...
			fragment = $('<div class="' + this.options.sugClass + '-wrapper" css="' + style + '" />');
		...
		this.each(function(){
			...
			'<div class="Huitags-wraper">'+
				...
				'<div class="Huitags-list">'+
					'<div class="Huitags-notag" css="display:none">暂无常用标签</div>'+
				...
				function() {
					...
					timer = setTimeout(function () {
						...
						if (bigImg == '') {
							...
							'<div id="preview-wraper" css="position: absolute;width:'+options.bigImgWidth+'px;height:auto;top:' + imgT + 'px;right:' + tooltipRight + ';left:' + tooltipLeft + '">'+
...
!function($) {
	...
	$.Huitotop = function(bottom){		
		...
		var str ='<a href="javascript:void(0)" class="tools-right toTop Hui-iconfont" title="返回顶部" alt="返回顶部" css="display:none;bottom:'+bottom+'px">&#xe684;</a>';
